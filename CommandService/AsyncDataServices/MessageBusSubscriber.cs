...
{
    // Long runing process listening for events data,  in background
    // No need for Interface, causes conflict
    public class MessageBusSubscriber : BackgroundService   // spin in background
    {
        ...
        public MessageBusSubscriber(IConfiguration configuration, IEventProcessor eventProcessor)
        {
            ...
            InitializeRabbitMQ();   // setting up diff this time around
        }
